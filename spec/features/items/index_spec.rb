...
RSpec.describe "Items Index Page" do
  describe "When I visit the items index page" do
    ...
    it "I see statistics on the top 5 most popular items." do
      ...
      within "#top-items" do 
        expect(page).to have_content("1. Treat Bandolier")
        expect(page).to have_content("2. Pull Toy")
        expect(page).to have_content("3. Dog Toothbrush")
        expect(page).to have_content("4. Snoopy Dog Toy")
        expect(page).to have_content("5. Bike Seat")
      end 
    end 
    ...
    #     expect(page).to have_content("1. Chain")
    #     expect(page).to have_content("2. Dog Toothbrush")
    #     expect(page).to have_content("3. Bike Basket")
