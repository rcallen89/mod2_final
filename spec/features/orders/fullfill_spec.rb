...
<<<<<<< HEAD
  ...
  it "changes order_items status to packaged when all items have been fulfilled" do
    ...
    item_order1 = ItemOrder.create(price: 6, quantity: 7, order: order, item: tire, fulfilled?: true)
    item_order2 = ItemOrder.create(price: 2, quantity: 2, order: order, item: paper, fulfilled?: true)
    item_order3 = ItemOrder.create(price: 1, quantity: 2, order: order, item: pencil, fulfilled?: true)
